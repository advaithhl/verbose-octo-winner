  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8">
        ...
        <div
          className={`mt-12 max-w-3xl mx-auto ${highContrast ? "bg-black border-2 border-white" : "bg-white shadow-xl"} rounded-2xl p-8 md:p-12`}
        >
          {" "}
          ...
          <h1
            className={`${fontSize === "text-xl" ? "text-3xl" : fontSize === "text-2xl" ? "text-4xl" : fontSize === "text-3xl" ? "text-5xl" : "text-6xl"} font-bold text-center mb-8 ${highContrast ? "text-white" : "text-blue-900"}`}
          >
          ...
          <div className={`${fontSize} space-y-6 mb-12`}>
            ...
            <div className="space-y-6">
              <div
                className={`p-6 rounded-xl ${highContrast ? "bg-blue-900 border-2 border-white" : "bg-blue-50"}`}
              >
                <h2
                  className={`${fontSize === "text-xl" ? "text-2xl" : fontSize === "text-2xl" ? "text-3xl" : fontSize === "text-3xl" ? "text-4xl" : "text-5xl"} font-bold mb-4 ${highContrast ? "text-white" : "text-blue-800"}`}
                >
          ...
          <div className="text-center mt-12">
            <p
              className={`${fontSize} ${highContrast ? "text-gray-300" : "text-gray-600"}`}
            >
