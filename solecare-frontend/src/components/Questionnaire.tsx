            ...
            <div className="flex justify-between items-center mb-2">
              <div className="flex items-center space-x-4">
                ...
                <button
                  ...
                  } transition-colors`}                  aria-label={language === 'de' ? "Zur Startseite" : "Go to home"}
            ...
            <div className="mb-8">
              <div className="flex items-start justify-between mb-6">
                ...
                <button
                  ...
                  aria-label={isReading                    ? language === 'de' ? "Vorlesen stoppen" : "Stop reading"
                    : language === 'de' ? "Frage vorlesen" : "Read question"}
                >
                  <FiVolume2 className={`w-6 h-6 ${isReading ? 'animate-pulse' : ''}`} />
                </button>
              </div>
              ...
              )}              {speechError && (                <div className={`p-4 mb-6 rounded-lg ${highContrast ? 'bg-red-900 text-white' : 'bg-red-100 text-red-800'} flex items-center`}>
                  <FiX className="w-6 h-6 mr-2" />
                  <span className={fontSize}>{speechError}</span>
                </div>
              )}              {showError && (                <div className={`p-4 mb-6 rounded-lg ${highContrast ? 'bg-red-900 text-white' : 'bg-red-100 text-red-800'} flex items-center`}>
                  <FiX className="w-6 h-6 mr-2" />
