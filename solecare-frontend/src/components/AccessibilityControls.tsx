...
const AccessibilityControls: React.FC = () => {
  ...
  return (
    <div
      className={`fixed top-0 right-0 p-4 z-10 rounded-bl-lg ${highContrast ? "bg-blue-900 text-white" : "bg-white shadow-md"}`}
    >
      <div className="flex items-center space-x-4">
        ...
        <button
          ...
          aria-label={
            language === "de" ? "Schriftgröße vergrößern" : "Increase font size"
          }
        >
        ...
        <button
          ...
          aria-label={
            language === "de" ? "Kontrast umschalten" : "Toggle contrast"
          }
        >
