  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8">
        ...
        <div
          className={`mt-12 max-w-4xl mx-auto ${highContrast ? "bg-black border-2 border-white" : "bg-white shadow-xl"} rounded-2xl p-8 md:p-12`}
        >
          {" "}
          <div className="flex justify-center mb-6">
            <FiCheckCircle
              className={`w-24 h-24 ${highContrast ? "text-white" : "text-green-600"}`}
            />
          </div>
          <h1
            className={`${fontSize === "text-xl" ? "text-4xl" : fontSize === "text-2xl" ? "text-5xl" : fontSize === "text-3xl" ? "text-6xl" : "text-7xl"} font-bold text-center mb-8 ${highContrast ? "text-white" : "text-blue-900"}`}
          >
          ...
          <div className={`${fontSize} text-center space-y-6 mb-12`}>
            ...
            <p
              className={`${highContrast ? "text-gray-300" : "text-gray-600"}`}
            >
          ...
          {/* Next Steps Section */}
          <div
            className={`${highContrast ? "bg-blue-900 border-2 border-white" : "bg-blue-50"} rounded-xl p-6 mb-8`}
          >
            <h2
              className={`${fontSize} font-bold mb-4 ${highContrast ? "text-white" : "text-blue-800"}`}
            >
              {translations.nextSteps[language]}
            </h2>
            <ul
              className={`${fontSize} space-y-3 ${highContrast ? "text-gray-300" : "text-gray-700"}`}
            >
              {" "}
